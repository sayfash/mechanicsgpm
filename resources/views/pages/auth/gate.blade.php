    ...
    <div class="glass-panel rounded-3xl p-8 sm:p-10 shadow-2xl relative overflow-hidden border border-slate-800 bg-slate-950/90 backdrop-blur-2xl">
        ...
        <div id="login-form-wrapper">
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="text-2xl sm:text-3xl font-extrabold text-slate-100 tracking-tight">SGPM MECHANIC</h2>
            ...
            <form onsubmit="handleLogin(event)" class="space-y-5">
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative group">
                        ...
                        <input type="text" id="login-username" required
                            class="w-full pl-11 pr-4 py-3 rounded-xl bg-slate-900 border border-slate-800 text-slate-100 placeholder-slate-500 text-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition duration-200" placeholder="Enter username">
                    </div>
                </div>
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative group">
                        ...
                        <button type="button" onclick="togglePasswordVisibility('login-password', 'toggle-pass-icon')" class="absolute inset-y-0 right-0 pr-3.5 flex items-center text-slate-500 hover:text-slate-300 transition focus:outline-none" title="Toggle password visibility">
